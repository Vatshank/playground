# Based on the original flop counter from https://dev-discuss.pytorch.org/t/the-ideal-pytorch-flop-counter-with-torch-dispatch/505/3
# but using bwd hooks instead of the push/pop
    ...
    def __init__(self, module = None):
        ...
        if module is not None:
            for name, module in dict(mod.named_children()).items():
                ...
                module.register_full_backward_pre_hook(self.enter_module(name))
                module.register_full_backward_hook(self.exit_module(name))
